        ...
        if ans in ["1", "01"]:
            ...
            try:
                ...
                if VERSION != check_version:
                    print("{}({}Goku{}) You're using an outdated version!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
                    webbrowser.open(f"https://github.com/notspeezy/Goku-Nuker/releases/tag/{check_version}")
                else:
                    print("{}({}Goku{}) You're using the current version!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            except:
                print("{}({}Goku{}) Couldn't reach the releases!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            ...
            print("- Goku Nuker on top!\n- Press enter to return.")
            input("")
            self.menu()
        
        elif ans == "12":
            print("{}({}Goku{}) Thanks for using Goku Nuker!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            time.sleep(1.5)
            os._exit(0)
...
if __name__ == "__main__":
    try:
        os.system("title Goku Nuker ^| Authentication & mode con: cols=95 lines=25")
